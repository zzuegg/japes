...
!!! note "Record allocation dominates this benchmark"
    ...
    — japes at 625 µs is almost exactly 10× the `simulateOneTick /
    10000` number (62.5 µs), which confirms that per-tick cost is
...
Roughly 7–9% under Valhalla — modest but real. Writes still allocate
